...
public class SprintBarUI : MonoBehaviour
{
    ...
    private void Update()
    {
        if (playerMovement.isSprinting)
        {
            ...
            fillBarActual.color = new Color(sprintBar.color.r, sprintBar.color.g, sprintBar.color.b, 100f);
        ...
        if(sprintBar.fillAmount >= 0.75f && !playerMovement.isSprinting)
        {
            ...
            fillBarActual.color = new Color(sprintBar.color.r, sprintBar.color.g, sprintBar.color.b, alphaValue);
