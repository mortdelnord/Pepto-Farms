...
public class WalkingScareCrow1 : ScareCrow, IDataPersistence
{
    ...
    {
        this.transform.position = data.crawlScareCrowPos;
        state = (State)data.crawlScareCrowState;
    ...
    {
        data.crawlScareCrowState = (int)state;
        data.crawlScareCrowPos = this.transform.position;
